...
public:
	...
	// for Server
	void ServerSendermain(std::string ServerPort, std::string ClientPort, std::string Keyword);
	void deqFromBQ(std::promise<std::string> &p);
	...
	//to be implemented
	void CopypathpatterntextforSileSearch(std::string path,std::string pattern);

	void CopyTextSearch(std::string textseearch);
	void SendFileSearch(std::string ServerPort, std::string ClientPort, std::string FileName, SocketConnecter &si);
	void ReceiveStringfromServerforFileSearch(std::string ServerPort, std::string ClientPort, std::string SearchedFilenames);
	void ReceiveStringfromServerforTextSearch(std::string ServerPort, std::string ClientPort, std::string TextSearchFiles);
	void SendTextSearch(std::string ServerPort, std::string ClientPort, std::string FileName, SocketConnecter &si);
	void HandleAcknowledgementforUploadSendSvr(std::string ClientPort, std::string ServerPort, SocketConnecter &si);
	void HandleDownloadSendSvr(std::string ClientPort, std::string ServerPort, SocketConnecter &si);
	void HandleFileSearchSendSvr(std::string ClientPort, std::string ServerPort, SocketConnecter &si);
	void HandleTextSearchSendSvr(std::string ClientPort, std::string ServerPort, SocketConnecter &si);
...
private:
	...
	std::string sendrpath = "";
	std::string sendrpattern = "";
	std::string sendrtextSearch = "";
	std::string FilenameSearches = "";
	std::string FilenamesforTextSearch = "";
